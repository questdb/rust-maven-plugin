...
public final class Platform {
    ...
    static boolean isSoftFloat() {
        try {
            ...
            // asume hardfloat
            Logger.getLogger(Platform.class.getName()).log(Level.INFO, "Failed to read '/proc/self/exe' or the target" +
                    " binary.", ex);
        } catch (SecurityException ex) {
            // asume hardfloat
            Logger.getLogger(Platform.class.getName()).log(Level.INFO, "SecurityException while analysing " +
                    "'/proc/self/exe' or the target binary.", ex);
        }
        return false;
    }
    ...
    static String getNativeLibraryResourcePrefix() {
        ...
        if (prefix != null) {
            ...
            return getNativeLibraryResourcePrefix(getOSType(), System.getProperty("os.arch"), System.getProperty("os" +
                    ".name"));
        }
    }
